...
app.config['MYSQL_DATABASE_USER'] = 'ummuhan'
app.config['MYSQL_DATABASE_PASSWORD'] = 'ummuhan_1'
...
# Write a function named `home` which returns 'Welcome to the Ummuhan's Bookstore API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Ummuhan's Bookstore API Service"
